...
;dir_upper = '/Volumes/Philippi/Processed3/'
dir_upper = '/Users/Kelbe/Desktop/EMEL/Processed/'
dir_temp = '/Users/Kelbe/Desktop/EMEL/Processed/'
dir_write = '/Users/Kelbe/Desktop/EMEL/ProcessedOut/'
...
for shot_seq = shot_start, shot_end do begin ;for each shot sequence 
  ...
  ; Read cube text file 
  filepath_cubes = dir_upper + 'cube' + '/' + 'cube.txt'
...
;    if all_exist then continue
    ...
    for b =0,set_num[s]-1 do begin
      ...
      filepath_image = dir_upper + cube + '/' + 'tiff' + '/' + cube + '+' + band_no_space + '.tif'
      im = 0; clear memory 
      ...
      if (b eq 0) then begin
        ...
        I = 0; 
        I = make_array(imsize[0],imsize[1],set_num[s], /uint)
      endif 
      ;i_scl = bytscl(i);    
    ...
    for r = 0,n_roi-1 do begin 
      ...
      for b = 0,set_num[s]-1 do begin
        ...
        ;filepath_image = dir_upper + cube + '/' + 'tiff' + '/' + cube + '+' + bands[b] + '.tif'
        temp = I[*,*,b];
        e_roi = 0;  
        e_roi = temp[isroi]
      ...
      ; Do ICA computation 
      filename_trans = dir_upper + cube + '/' + 'envi/' + cube + '_c' + set_str + '_m' + roi_str + '.trans'
